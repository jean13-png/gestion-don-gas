...
export default function TrackReferenceForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-5 space-y-3" noValidate>
      ...
      <button
        type="submit"
        className="inline-flex items-center justify-center gap-2 h-11 px-5 rounded-md bg-[var(--color-ong-bleu)] cursor-pointer text-white text-[14px] font-medium hover:brightness-95 transition"
      >
